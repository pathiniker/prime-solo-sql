...
LIMIT 3;
 ...
 -- 6. Get the username and account balance
 -- of the 3 users with the lowest balances,
...
VALUES (9, 'Steve', 'Chinatown', 50, 65, 35000);

-- 9. The bank is losing money in Miami and Phoenix and
-- needs to unload low transaction customers:
-- Delete users that reside in miami OR phoenix
